...
def prompt_for_password():
    ...
    if master_hash is None:
        pw, ok = QInputDialog.getText(None, "Set Master Password", "Create master password:", echo=QLineEdit.EchoMode.Password)
        if ok and pw:
        ...
        while True:
            pw, ok = QInputDialog.getText(None, "Master Password", "Enter master password:", echo=QLineEdit.EchoMode.Password)
            if not ok:
                sys.exit()
